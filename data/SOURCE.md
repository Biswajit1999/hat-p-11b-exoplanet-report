...
- `helium_10830_line_profile.txt` (source: `Fig_2a.txt`) — the real
  helium 10830 A triplet absorption-line profile from HARPS-N/GIANO-B
  spectra: wavelength in air Angstroms, two individual-night excess
...
high-significance result from the phase-folded light curve file, which
combines many more in-transit exposures, and uses the line-profile file
only for a qualitative, descriptive figure of the absorption region.
